...
fact CircuitGraph {
	...
	let l_7 = l_6.next   | l_7.edges  = (q_1 -> q_2) &&
	let l_8 = l_7.next   | l_8.edges  = (q_1 -> q_3) &&
	let l_9 = l_8.next   | l_9.edges  = (q_1 -> q_4) &&
	let l_10 = l_9.next  | l_10.edges = (q_1 -> q_5) &&
	let l_11 = l_10.next | l_11.edges = (q_1 -> q_6) &&
	let l_12 = l_11.next | l_12.edges = (q_2 -> q_3) &&
	let l_13 = l_12.next | l_13.edges = (q_2 -> q_4) &&
	let l_14 = l_13.next | l_14.edges = (q_2 -> q_5) &&
	let l_15 = l_14.next | l_15.edges = (q_2 -> q_6) &&
	let l_16 = l_15.next | l_16.edges = (q_3 -> q_4) &&
...
run finalLayer for 22 circGraph, 9 Int
